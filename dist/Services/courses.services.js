...
const createCourse = (courseCode, courseTitle, credit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllCourse = (page = 1, pageSize = utils_1.defaultPageSize) => __awaiter(void 0, void 0, void 0, function* () {
    const skip = (page - 1) * pageSize;
    const take = pageSize;
    return yield prisma_1.default.course.findMany({
        skip,
        take,
