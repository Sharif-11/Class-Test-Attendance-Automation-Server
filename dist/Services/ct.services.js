...
const cancelEvaluation = (classTestId) => __awaiter(void 0, void 0, void 0, function* () {
    yield getCt(classTestId);
    const transactionResult = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        const deleteMarks = yield tx.mark.deleteMany({ where: { classTestId } });
        if (!deleteMarks) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Evaluation cancelling failed');
        }
        const updatedCt = yield tx.class_Test.update({
            where: { classTestId },
...
const getAllCtResult = (semesterId, courseCode, studentId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let totalMarks = 0, minMark = Infinity;
