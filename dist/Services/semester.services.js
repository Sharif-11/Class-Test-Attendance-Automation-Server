...
const createSemester = (semesterTitle, batch, session) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const semesterId = (0, utils_services_1.createSemesterId)(
      semesterTitle,
      batch,
    )
...
const getSemester = semesterId =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.semester.findUnique({
      where: { semesterId },
    })
    if (!result) {
...
const getAllSemesters = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default.semester.findMany()
  })
...
const deleteSemester = semesterId =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield getSemester(semesterId)
    const result = yield prisma_1.default.semester.delete({
      where: { semesterId },
    })
    return result
  })
const assignCourse = (semesterId, courseCode, teacherId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const assignedCourse = yield prisma_1.default.semester_Courses.create({
      ...
      include: {
        ...
        course: {
          select: { courseCode: true, courseTitle: true, credit: true },
        },
        teacher: {
          select: {
            name: true,
...
const getSemesterCourses = semesterId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const coursesWithTeachers = yield Promise.all(
      coursesForSemester.map(({ course }) =>
        __awaiter(void 0, void 0, void 0, function* () {
          const teachersForCourse =
            yield prisma_1.default.semester_Courses.findMany({
              where: {
                semesterId,
...
const unassignCourse = (semesterId, courseCode, teacherId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield getSemester(semesterId)
    yield courses_services_1.courseServices.getCourse(courseCode)
    yield user_services_1.userServices.getSingleTeacher(teacherId)
...
const getSemesterOfStudent = studentId =>
  __awaiter(void 0, void 0, void 0, function* () {
