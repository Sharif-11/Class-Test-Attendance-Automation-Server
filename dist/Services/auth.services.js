...
const studentLogin = (studentId, password) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      !existingStudent ||
      !(0, utils_services_1.comparePasswords)(
        password,
    ...
    const { password: currentPassword } = existingStudent,
      otherData = __rest(existingStudent, ['password'])
    return otherData
  })
const teacherLogin = (teacherId, password) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const { password: currentPassword } = existingTeacher,
      otherData = __rest(existingTeacher, ['password'])
    return otherData
  })
