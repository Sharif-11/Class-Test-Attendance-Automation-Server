...
const createStudent = (studentId, name, email, batch, session, profileImage, department, password) => __awaiter(void 0, void 0, void 0, function* () {
...
const getTeachers = (page = 1, pageSize = utils_1.defaultPageSize) => __awaiter(void 0, void 0, void 0, function* () {
...
const getStudentsOfBatch = (batch, page = 1, pageSize = 10) => __awaiter(void 0, void 0, void 0, function* () {
    const skip = (page - 1) * pageSize;
    const take = pageSize;
