...
const createTeacher = teacherData =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (deptHead === true) {
      const existingHead = yield prisma_1.default.teacher.findFirst({
        where: { deptHead },
      })
      if (existingHead) {
...
const updateStudent = (studentId, studentData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { password } = studentData,
      otherData = __rest(studentData, ['password'])
...
const updateTeacher = (teacherId, teacherData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const { password, deptHead } = teacherData,
      otherData = __rest(teacherData, ['password', 'deptHead'])
...
const getSingleTeacher = teacherId =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateTeacherPassword = (teacherId, newPassword) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const makeHead = teacherId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedHead = yield prisma_1.default.$transaction(tx =>
      __awaiter(void 0, void 0, void 0, function* () {
        const nullifyHead = yield tx.teacher.update({
          where: {
            teacherId:
              currentHead === null || currentHead === void 0
                ? void 0
                : currentHead.teacherId,
          },
          data: { deptHead: false },
        })
        if (!nullifyHead) {
