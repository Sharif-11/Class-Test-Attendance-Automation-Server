...
const takeAttendance = (semesterId, courseCode, date, attendances) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const today = (0, utils_services_1.timestampToDate)(date.getTime());
    // if (!isToday) {
...
const getAttendance = (semesterId, courseCode, date, pageNo = 1, pageSize = 9) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.attendance.findUnique({
        where: {
    ...
    if (!result) {
        const students = yield user_services_1.userServices.getStudentsOfBatch(existingSemester.batch, pageNo, pageSize);
        return {
            semesterId,
            courseCode,
            date: today,
