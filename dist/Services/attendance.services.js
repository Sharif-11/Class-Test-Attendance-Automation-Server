...
const takeAttendance = (semesterId, courseCode, date, attendances) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isToday = (0, utils_services_1.verifyDate)(date)
    if (!isToday) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
        'The given date is incompatible',
      )
    }
    ...
    if (existingAttendance) {
      ...
      const result = yield prisma_1.default.$transaction(tx =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          const createdStudentAttendances =
            yield tx.student_Attendance.createMany({
              data: attendanceData,
            })
...
const calclateStudentAttendance = (semesterId, courseCode, studentId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield semester_services_1.semesterServices.getSemester(semesterId)
    yield courses_services_1.courseServices.getCourse(courseCode)
...
const tabulateStudentAttendance = (semesterId, courseCode) =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield semester_services_1.semesterServices.getSemester(semesterId)
    yield courses_services_1.courseServices.getCourse(courseCode)
    const existingSemesterCourses =
    ...
    const studentTotalAttendance =
      yield prisma_1.default.student_Attendance.groupBy({
