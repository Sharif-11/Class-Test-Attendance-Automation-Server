...
const createStudent = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _b = req.body, { password } = _b, others = __rest(_b, ["password"]);
    const result = yield user_services_1.userServices.createStudent(Object.assign(Object.assign({}, others), { password: (0, utils_services_1.hashPassword)(password), role: 'student' }));
    (0, response_services_1.sendSuccessResponse)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        data: result,
