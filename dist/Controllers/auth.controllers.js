...
const studentLogin = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { studentId, password } = req.body
    const student = yield auth_services_1.authServices.studentLogin(
      studentId,
      password,
    )
...
const teacherLogin = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { teacherId, password } = req.body
    const teacher = yield auth_services_1.authServices.teacherLogin(
      teacherId,
      password,
    )
...
exports.authControllers = { studentLogin, teacherLogin }
