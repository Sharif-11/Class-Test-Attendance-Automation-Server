...
const takeAttendance = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { courseCode, semesterId, date, attendances } = req.body
    const data = yield attendance_services_1.attendanceServices.takeAttendance(
      semesterId,
      courseCode,
      new Date(date),
      attendances,
...
const calculateStudentAttendance = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { semesterId, courseCode } = req.body
    const { studentId } = req.user
    const data =
      yield attendance_services_1.attendanceServices.calclateStudentAttendance(
        semesterId,
        courseCode,
        studentId,
      )
...
const tabulateStudentAttendance = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { courseCode } = req.params
    const { semesterId } = req.body
    const data =
      yield attendance_services_1.attendanceServices.tabulateStudentAttendance(
        semesterId,
        courseCode,
      )
    ;(0, response_services_1.sendSuccessResponse)(res, {
