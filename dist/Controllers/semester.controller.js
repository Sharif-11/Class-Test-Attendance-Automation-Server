...
const createSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = yield semester_services_1.semesterServices.createSemester(
      semesterTitle,
      batch,
      session,
    )
...
const getAllSemesters = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const data = yield semester_services_1.semesterServices.getAllSemesters()
    ;(0, response_services_1.sendSuccessResponse)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const updateSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = yield semester_services_1.semesterServices.updateSemester(
      semesterId,
      req.body,
    )
    ;(0, response_services_1.sendSuccessResponse)(res, {
...
const deleteSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { semesterId } = req.params
    const data =
      yield semester_services_1.semesterServices.deleteSemester(semesterId)
    ;(0, response_services_1.sendSuccessResponse)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const getSemestersOfStudent = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { studentId } = req.user
    const data =
      yield semester_services_1.semesterServices.getSemesterOfStudent(studentId)
    ;(0, response_services_1.sendSuccessResponse)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const getSemesterCourses = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { semesterId } = req.params
    const data =
      yield semester_services_1.semesterServices.getSemesterCourses(semesterId)
    ;(0, response_services_1.sendSuccessResponse)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const assignCourse = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { semesterId } = req.params
    const { teacherId, courseCode } = req.body
    const data = yield semester_services_1.semesterServices.assignCourse(
      semesterId,
      courseCode,
      teacherId,
    )
