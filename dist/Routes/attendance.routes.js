...
attendanceRoutes.post(
  '/',
  attendance_validator_1.attendanceValidators.validateTakeAttendance,
...
attendanceRoutes.get(
  ...
  attendance_validator_1.attendanceValidators
    .validateCalculateStudentAttendance,
  (0, verifyUser_1.default)('student'),
  verifyBatch_1.default,
  attendance_controllers_1.attendanceController.calculateStudentAttendance,
)
attendanceRoutes.get(
  '/tabulate-attendance/:courseCode',
  attendance_validator_1.attendanceValidators.validateTabulateStudentAttendance,
  (0, verifyUser_1.default)('teacher'),
  verifyInstructor_1.default,
  attendance_controllers_1.attendanceController.tabulateStudentAttendance,
)
