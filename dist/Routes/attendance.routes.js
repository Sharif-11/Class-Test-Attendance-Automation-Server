...
attendanceRoutes.post('/', attendance_validator_1.attendanceValidators.validateTakeAttendance, (0, verifyUser_1.default)('teacher'), verifyInstructor_1.default, attendance_controllers_1.attendanceController.takeAttendance);
attendanceRoutes.get('/calculate-attendance', attendance_validator_1.attendanceValidators.validateCalculateStudentAttendance, (0, verifyUser_1.default)('student'), verifyBatch_1.default, attendance_controllers_1.attendanceController.calculateStudentAttendance);
